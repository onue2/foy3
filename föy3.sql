...
==========================================================================================
Begin transaction;
insert into Birimler values('1','Yazýlým');
insert into Birimler values('2','Donaným');
...
insert into Unvan values ('4','Yönetici Yardýmcýsý','2016-06-11 00:00:00.000');
insert into Unvan values ('7','Personel','2016-06-11 00:00:00.000');
insert into Unvan values ('6','Takým Lideri','2016-06-11 00:00:00.000');
insert into Unvan values ('3','Takým Lideri','2016-06-11 00:00:00.000');
commit transaction;
============================================================================================
...
=========================================================================================
SELECT c.calisan_birim_id, b.birim_adi, COUNT(*) AS ÇalýþanSayýsý
FROM Calisanlar c 
join Birimler b on b.birim_id=c.calisan_birim_id
GROUP BY c.calisan_birim_id, b.birim_adi;
=========================================================================================
select COUNT(unvan_calisan) as AynýÜnvanaSahipBirdenFazlaÇalýþanSayýsý, unvan_calisan
from unvan
